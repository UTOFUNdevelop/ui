...
import MenuItem, { propTypes as menuItemPropTypes } from "./MenuItem";
...
type NavbarProps = InferProps<typeof propTypes>;
...
export default function Navbar({ items, _image }: NavbarProps) {
  const [isMenuOpen, toggleMenu] = useReducer(invert, false);
